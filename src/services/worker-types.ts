...
export interface ActiveSession {
  ...
  currentProvider: 'claude' | 'gemini' | 'openrouter' | 'groq' | 'ccproxy-openrouter' | 'ccproxy-groq' | 'minimax' | null;  // Track which provider is currently running
  providerFailoverTried?: Array<'claude' | 'gemini' | 'openrouter' | 'groq' | 'ccproxy-openrouter' | 'ccproxy-groq' | 'minimax'>;  // Track backup providers already attempted in the current failover chain
